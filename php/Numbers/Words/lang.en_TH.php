...
require_once "../php/Numbers/Words.php";
 ...
 * @link     http://pear.php.net/package/Numbers_Words
 */
class Numbers_Words_en_TH extends Numbers_Words
{
    ...
    var $_currency_names = array(
      ...
      'THB' => array(array('baht'), array('satang')),
     ...
     * @access public
     */
    var $def_currency = 'THB'; // Thai Baht
